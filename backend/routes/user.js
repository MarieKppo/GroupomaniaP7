...
router.put('/pseudo/:id', auth, userCtrl.modifyUserPseudo); //modifier un user
router.put('/profilePic/:id', auth, userCtrl.modifyUserPic); //modifier un user
router.put('/password/:id', auth, userCtrl.modifyUserPassword); //modifier un user
